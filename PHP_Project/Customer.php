...
if (isset($_GET['submit_search'])) {
    ...
    $customer_array = $database->selectFromCustomerWhere($customer_ID, $first_name, $last_name);
}
else {
    $customer_array = [];
}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="center gap fade-down section-heading">
                                <h1 class="main-title" style="color:black">Customers</h1>
                                <hr>
                ...
                <div class="portfolio-item apps isotope-item mt-2 col-md-4">
                    ...
                    <form method="post" action="addCustomer.php">
                        ...
                        <div class="form-group">
                            ...
                            <input id="first_name" name="first_name" class="form-control" type="text" maxlength="30">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="licence_nr">Licence Number</label>
                            <input id="licence_nr" class="form-control" name="licence_nr" type="text" maxlength="30">
                        </div>

                        <div class="form-group">
                            <label for="phone_nr">Phone Number</label>
                            <input id="phone_nr" class="form-control" name="phone_nr" type="text" maxlength="30">
                        </div>
                ...
                <div class="portfolio-item apps isotope-item mt-2 col-md-4">
                    ...
                    <form method="post" action="updateCustomer.php">
                        ...
                        <div class="form-group">
                            ...
                            <input id="customer_ID" class="form-control" name="customer_ID" type="number" maxlength="30">
                        </div>
                        <div class="form-group">
                            <label for="new_licence_nr">New Licence Number</label>
                            <input type="text" class="form-control" name="new_licence_nr" id="new_licence_nr">
                        </div>

                        <div class="form-group">
                            <label for="new_phone_nr">New Phone Number</label>
                            <input id="new_phone_nr" class="form-control" name="new_phone_nr" type="text" maxlength="30">
                        </div>
            ...
            <div class="row justify-content-center mt-2 col-md-12">
                <div class="portfolio-item apps isotope-item mt-2 col-md-5">
                    ...
                    <form method="get">
                        ...
                        <div class="form-group">
                            <label for="customer_ID">Customer ID</label>
                            <input class="form-control" id="customer_ID" name="customer_ID" type="number" value='<?php echo $customer_ID; ?>' min="0">
                        </div>
                    ...
                    <h3><?php echo strval(count($customer_array)) . " Results"; ?></h3>
                    <br>
                    
                    <!-- Search result -->
                    <h2><b>Customer Search Result:</b></h2>
                    <table class="table">
                        ...
                        <?php foreach ($customer_array as $cust) : ?>
                            <tr>
                                <td><?php echo $cust['CUSTOMER_ID']; ?>  </td>
                                <td><?php echo $cust['FIRST_NAME']; ?>  </td>
                                <td><?php echo $cust['LAST_NAME']; ?>  </td>
                                <td><?php echo $cust['LICENCE_NR']; ?>  </td>
                                <td><?php echo $cust['PHONE_NR']; ?>  </td>
                                <td><?php echo $cust['ORDERS']; ?>  </td>
                            </tr>
                        <?php endforeach; ?>
                    </table>
